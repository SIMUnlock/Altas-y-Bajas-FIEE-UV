    ...
    <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="panel panel-primary">
              <div class="panel-heading"> <center> <h3>Consultar Baja</h3> </center> </div>
...
<%
    ...
    LinkedList<Baja> lista = TablaBaja.getBajas("1","","","",depa);
for (int i=0;i<lista.size();i++)
{
   ...
   out.println("<td><a ID= 'eliminarBaja' href='\'><i class='fa fa-times fa-2x'></i>&nbspEliminar</a><a id='modificar' href='Modificarbaja.jsp?id="+lista.get(i).getid_BajasV()+"'><br><i class='fa fa-pencil fa-2x'></i>&nbspModificar</a></td>");
   out.println("</tr>");
