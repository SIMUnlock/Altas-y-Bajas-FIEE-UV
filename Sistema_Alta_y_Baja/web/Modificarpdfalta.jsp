...
<html lang="en">
<head>
     <title>Modificar PDF Alta</title>
...
<div id="page-content-wrapper">
    <div class="container-fluid">
      <input class="large" type="hidden" name="user" id="op" value="MP"/>
        <div class="row">
             <div class="col-lg-12 col-md-offset-0 ">
          <div class="panel panel-primary">
              <div class="panel-heading"> <center> <h3> Modificar PDF Alta</h3> </center> </div>
            <div class="panel-body">
              <div class="container-fluid">
                  <div class="row">
                    <a  href="Modificaralumno.jsp?M=<%out.println(Matricula+"&AB=MPA"+"&D="+Fecha+"&H="+Hora+"&I="+id);%>" class="btn btn-link col-xs-5 col-md-3 col-xs-offset-2 col-md-offset-0 " >&nbspModificar Alumno</a>
                  </div>
                  <div class="row">
...
<%
    ...
    LinkedList<Alta> lista = TablaAlta.getAltas("2",Matricula,Fecha,Hora,depa);
for (int i=0;i<lista.size();i++)
{
   ...
   out.println("<td ><select class='form-control input-sm' name='opo' id='opo'>");
            ...
            out.println("<td ><select class='form-control input-sm' name='tip' id='tip'>");
                                 ...
                                 out.println("</select></td>");
   out.println("<td ><a ID= 'eliminarAlta' href='\'><i class='fa fa-times fa-2x'></i>&nbspEliminar</a><a id='modificarPA' href='\'><br><i class='fa fa-pencil fa-2x'></i>&nbspModificar</a></td>");
   out.println("</tr>");
}
%></tbody>
</table>
            ...
            <div class="panel-footer">
                ...
                <div class="raw">
                    <div class="col-md-12">
              <a id="REVIA" class="btn btn-primary btn-lg col-md-3 col-md-offset-8 " ><i class="fa fa-print"></i>&nbspImprimir</a>
                    </div>
                </div>
                </div>
            </div>  
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content"> 
                            ...
                            <div class="modal-footer">
                                <a id="descarga3"  class="btn btn-primary btn-lg col-md-3 col-md-offset-5 "  >DESCARGA</a>
                            </div>
                        </div>
                    </div>
                </div>
