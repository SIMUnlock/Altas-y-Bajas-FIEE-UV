...
<% HttpSession objsesion = request.getSession(true);
    ...
    else if(a.equals("admin") || a.equals("usuario") || a.equals("superadmin") || a.equals("superusuario") || invitado.equals("invitado") )
    {
        elec="Si";
    }
...
<body>
  ...
  <div class="wrapper">
      <%if(a.equals("admin") || a.equals("usuario") || a.equals("superadmin") || a.equals("superusuario") )
    {%>
