...
<html>
    <head>
      ...
      <script type="text/javascript" src="js/TablaRegistroBaja.js"></script>
...
<div id="page-content-wrapper">
    <div class="container-fluid">
                  ...
                  <div class="row">    
                    ...
                    <div class="form-group col-xs-12 col-sm-4 col-md-3 col-md-offset-1">
                      ...
                      <div class="input-group ">
                        ...
                        <input type="text" id="car" disabled=”disabled” value="<%out.println(carrera);%>" name="progc" class="form-control">
                      </div>
                    </div>
      ...
      <div class="col-md-7 col-md-offset-1">
            <div class="panel panel-primary">
                <div class="panel-heading"><h3>Baja</h3></div>
            <div class="panel-body">
              <div class="container-fluid">
              <div class="row"> 
                  <div class="col-xs-12 col-md-12">
                  ...
                  <div id="mo" style="display: none;">
                       <a id="REVIB" class="btn btn-primary btn-lg col-md-3 col-md-offset-8 " >enviar</a>
                       </div >
                           </div>
        </div>
                  </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content"> 
                            ...
                            <div class="modal-footer">
                                <a id="descarga1"  class="btn btn-primary btn-lg col-md-3 col-md-offset-5 "  >DESCARGA</a>
                            </div>
                        </div>
                    </div>
                </div>
