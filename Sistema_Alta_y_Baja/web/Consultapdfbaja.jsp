...
<%@page import="Modelo.tablas.TablaPDFBaja"%>
...
<html lang="en">
<head>
     <title>Consultar PDF Baja</title>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="panel panel-primary">
              <div class="panel-heading"> <center> <h3>Consulta PDF Baja</h3> </center> </div>
...
<%
    ...
    LinkedList<PDF> lista = TablaPDFBaja.getPDF(depa);
