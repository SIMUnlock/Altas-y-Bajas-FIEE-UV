...
<% HttpSession objsesion = request.getSession(true);
    ...
    else if(a.equals("admin") || a.equals("usuario") || a.equals("superadmin") || a.equals("superusuario") )
    {
    ...
    <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="panel panel-primary">
              <div class="panel-heading"> <center> <h3>Consultar Departamento</h3> </center> </div>
...
for (int i=0;i<lista.size();i++)
{
   ...
   if(!a.equals("usuario"))
   out.println("<td><a ID= 'eliminarDape' href='\'><i class='fa fa-times fa-2x'></i>Eliminar</a><a id='modificar' href='ModificarDepartamento.jsp?id="+lista.get(i).getId()+"'><br><i class='fa fa-pencil fa-2x'></i>Modificar</a></td>");
   else
       out.println("<td></td>");
   out.println("</tr>");
}
