<%-- 
    Document   : CupoIL
    Created on : 27/10/2016, 05:03:33 PM
    Author     : Rodolfo2403
--%>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="panel panel-primary">
              <div class="panel-heading"> <center> <h3>Lugares IL</h3> </center> </div>
            <div class="panel-body">
              ...
              <div class="container-fluid">
                <div class="row">
                  <a  id="RIL" class="btn btn-primary btn-lg col-md-3 col-xs-offset-3 col-sm-offset-5  col-md-offset-8  "><i class="fa fa-floppy-o"></i>&nbspRegistrar</a>
               </div>
              </div>
            </div>  
        </div>       
