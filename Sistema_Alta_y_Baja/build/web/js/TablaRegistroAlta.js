...
$(document).ready(function() {
    ...
    $('#example tbody').on('click', 'td.details-control', function () {
     ...
     // Add event listener for opening and closing details
		...
		if(con==1 || con==2 || con==3 || con==7 || con==5|| con==8 || con==9 || con==10 || con==11 || con== 12 || con== 13 ){
                    if(con==12)
                    valores+='<td>'+opo+'</td>';
                    else if(con==13)
                    valores+='<td>'+tip+'</td>';
                ...
                {   num=$(this).html();
                    ...
                    num2=$("#total").html();
                    var num3=num2.split("=");                     
                     cont=parseInt(num)+parseInt(num3[1]);
                      
                }
                
con++;
            });$("#total").html("Total="+cont);
 	...
 	var valore="<td class='boto' style='text-aling:center'><a onclick='Eliminar(this.parentNode.parentNode.rowIndex)'><center><i class='fa fa-times fa-2x'></i></center>Eliminar</a></td></tr></tbody> "+
                       '</table>';
