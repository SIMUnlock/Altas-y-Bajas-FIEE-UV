...
<%@page import="Modelo.ConsultarCarrera"%>
...
<body>
    <% int id =Integer.parseInt(request.getParameter("id"));
                         ConsultarCarrera c = new ConsultarCarrera();
                         Carrera p=c.getCarrera(id);
    %>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="panel panel-primary">
              <div class="panel-heading"> <center> <h3>Modificar Carrera</h3> </center> </div>
            <div class="panel-body">
              <div class="container-fluid">
                  ...
                  <div class="row">
                    ...
                    <div class="input-group ">
                        <label for= "Nombre de la Carrera" >Nombre de la Carrera:</label>
                        <input class="form-control" type="text" <% out.println("value='"+p.getCarrera()+"'"); %> id="carrera" name="carrera" /><br>
                         </div>
                    </div>
                      ...
                      <div class="form-group col-xs-7 col-sm-3  col-md-3 col-xs-offset-3 col-sm-offset-1 col-md-offset-0 ">
                         ...
                         <div class="input-group ">
                              ...
                              <input class="form-control" <% out.println("value='"+p.getClave()+"'"); %> type="text" id="clave" name="clave" /><br>
              ...
              <div class="container-fluid">
                <div class="row">
                  <a type="button" id="MCARRE" class="btn btn-primary btn-lg col-md-3  col-xs-offset-5  col-md-offset-8 "><i class="fa fa-floppy-o"></i>&nbspModificar</a>
               </div>
              </div>
            </div>  
        </div>       
