 ...
 * @author trdni
 */
public class RegistrarPreil extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       int id=Integer.parseInt(request.getParameter("iden"));
        ...
        ConsultaPreil co = new ConsultaPreil();
       ...
       ConsultaCargaAcademica carg = new ConsultaCargaAcademica();
        ...
        {   
            ...
            if(co.registrar_Preil(EE,NRC,LO,CupoL,Max,P)){
                response.getWriter().println("Exito al guardar Preil los Lugares libres son: "+CupoL);
            
            }else{
                response.getWriter().println(3+cup.getId());
