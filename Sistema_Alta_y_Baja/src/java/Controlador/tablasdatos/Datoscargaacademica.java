 ...
 * @author trdni
 */
public class Datoscargaacademica extends HttpServlet {
         ...
         for (int i=0;i<lista.size();i++)
{
   ...
   int sobra= Integer.parseInt(lista.get(i).getCupoM())-Integer.parseInt(lista.get(i).getCupo()); 
    empObj = new JSONObject();
            ...
            empObj.put("CI",lista.get(i).getCatedratico()+" "+lista.get(i).getCatedraticoP()+" "+lista.get(i).getCatedraticoM() );
            empObj.put("CT",lista.get(i).getTIC()+" "+ lista.get(i).getTICP()+" "+lista.get(i).getTICM());
            ...
            if(!a.equals("usuario"))
            empObj.put("EL","<a class='eliminarCar' ><i class='fa fa-times fa-2x'></i>Eliminar</a><a href='Modificarcargaacademica.jsp?id="+lista.get(i).getId()+"'><br><i class='fa fa-pencil fa-2x'></i>Modificar</a>" );
            else
                empObj.put("EL"," ");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(Datoscargaacademica.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
