 ...
 * @author trdni
 */
public class Datoscargaacademicapreil extends HttpServlet {
         ...
         for (int i=0;i<lista.size();i++)
{
   ...
   int sobra= Integer.parseInt(lista.get(i).getCupoM())-Integer.parseInt(lista.get(i).getCupo()); 
    empObj = new JSONObject();
            ...
            empObj.put("EL","<a type='button' class='boton btn btn-primary btn-xs ' id='AV' href='CupoPreil.jsp?id="+lista.get(i).getId()+"'>Cupo PreIL</a>" );
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(Datoscargaacademicapreil.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
