 ...
 * @author trdni
 */
public class DatosAlta extends HttpServlet {
    ...
    else if(a.equals("admin") || a.equals("usuario") || a.equals("super") )
    {
        ...
        Calendar cal= Calendar.getInstance();
         ...
         LinkedList<CargaAcademica> lista = TablaCargaAcademica.getCargaAdemica("dos","","",P,"","",ca,departamento);
   ...
   int sobra= Integer.parseInt(lista.get(i).getCupoM())-Integer.parseInt(lista.get(i).getCupo()); 
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(DatosAlta.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
