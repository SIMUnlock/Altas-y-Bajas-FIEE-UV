 ...
 * @author trdni
 */
public class Datosregistroalta extends HttpServlet {
         ...
         for (int i=0;i<lista.size();i++)
{
    ...
    empObj = new JSONObject();
            ...
            /*empObj.put("Salon",SL);
            empObj.put("SalonM",SM);
            empObj.put("SalonMI",SMI);
            empObj.put("SalonJ",SJ);
            empObj.put("SalonV",SV);*/
            ...
            empObj.put("LU",sobra );
            empObj.put("L",LI+"-"+LF +SL);
            empObj.put("M",MI+"-"+MF +SM);
            empObj.put("MI",MII+"-"+MIF+ SMI);
            empObj.put("J",JI+"-"+JF+SJ );
            empObj.put("V",VI+"-"+VF +SV);
            empObj.put("opo","<select class='form-control input-sm¿ name='opo' id='opo'>" +
                                  "<option selected='selected'>opcion</option>" +
                                  "<option  >Primera</option>" +
                                  "<option  >Segunda</option>" +
                                  "</select>" );
            empObj.put("tip","<select class='form-control input-sm¿ name='tip' id='tip'>" +
                                  "<option selected='selected'>opcion</option>" +
                                  "<option  >Normal</option>" +
                                  "<option  >Electiva</option>" +
                                  "<option  >Optativa</option>" +
                                  "</select>" );
            empObj.put("AL","<td ><a type='button' class='boton btn btn-primary btn-xs '>Alta</a></td>" );
   ...
   out.println("</tr>");*/
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(Datosregistroalta.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
