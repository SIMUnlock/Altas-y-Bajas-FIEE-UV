 ...
 * @author trdni
 */
public class EliminarAlta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      ConsultaAlta a= new ConsultaAlta();
      ConsultaAlta al=new ConsultaAlta();
      
      Alta altas= al.getAlta(id);
      ...
      CargaAcademica cup=carga.getCargaNrc(altas.getNRC());
      
      int cupo=Integer.parseInt(cup.getCupo());
      
      int cupoN = cupo-1;
      
        if(a.eliminar_Alta(id)){
           carg.Dar_AltaNRC(altas.getNRC(),cupoN);

           response.getWriter().println("Alta eliminada");
