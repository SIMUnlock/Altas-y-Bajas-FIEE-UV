...
public class Autentificacion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       String user = request.getParameter("user");
        ...
        Usuario busuario= Con.consultarUsuario(user);
        ...
        if(con.Autenticacion(user, pass)){
            ...
            objsesion.setAttribute("a",busuario.getTipo());
            objsesion.setAttribute("b",busuario.getId());
            objsesion.setAttribute("depa",busuario.getDepartamento());
            if(busuario.getTipo().equals("admin"))
            {
