...
public class ModificarPDFAlta {
    ...
    public ModificarPDFAlta(String ID,String Periodo,String Matricula,String Nombre,String ApellidoP,String ApellidoM,String NRC,String EE,String Usuario,String Acciones,String Op,String tipo) {
  super();
  this.ID=ID;
  this.Nombre=Nombre;
  this.Apellido_Paterno=ApellidoP;
