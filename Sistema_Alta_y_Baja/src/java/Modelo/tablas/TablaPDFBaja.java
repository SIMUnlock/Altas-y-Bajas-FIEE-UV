    ...
    public static LinkedList<PDF> getPDF(int dep)
   {
      ...
      try
      {
        ...
        String Consulta;
         ...
         Consulta = "Select id_pdf,Amatricula,fecha,dia,hora,Ncarrera,estado,Departamento from pdf inner join alumno on pdf.nombre=alumno.idAlumno  where Departamento='"+dep+"' ";
